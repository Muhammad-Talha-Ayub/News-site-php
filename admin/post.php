      ...
      <div class="container">
          <div class="row">
              ...
              <?php 
                ...
                // SELECT post.post_id, post.title, post.description, post.post_img, post.post_date, category.category_name, user.username 
                // FROM post
                ...
                // LIMIT {$offset}, {$limit}
                // "; without left in join it is also working the same
                if($_SESSION["role"]== '1'){
                $sql = "
                SELECT * FROM post
                ...
                ?>
                  ...
                  $sql1= "SELECT * FROM post";
                    ...
                    if(mysqli_num_rows($result) > 0){
                        ...
                        if($page > 1){
                            echo '<li><a href="post.php?page='.($page-1).'">Previous</li>';
                        }
