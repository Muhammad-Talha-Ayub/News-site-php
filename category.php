                ...
                $offset = ($page-1)*$limit;
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    <div class="inner-content clearfix">
                                        <h3><a href="single.php?id=<?php echo $row['post_id'] ?>&cid=<?php echo $row['category']; ?>"><?php echo $row['title'] ?></a></h3>
                   ...
                   $sql1 = "SELECT * FROM post WHERE category = {$cat_id}";
                    ...
                    if(mysqli_num_rows($result) > 0){
                        ...
                        if($page > 1){
                            echo '<li><a href="category.php?cid='.$cat_id.'&page='.($page-1).'">Previous</a></li>';
                        }
